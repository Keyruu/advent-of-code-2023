    ...
    for line in input.lines() {
        ...
        for subset in subsets {
            ...
            for cube in cubes {
                ...
                let cube_amount = trimmed_cube_split[0];
                let cube_color = trimmed_cube_split[1];

                match cube_color {
                    "red" => if cube_amount.parse::<i32>().unwrap() > 12 {
                        game_impossible = true;
                    },
                    "green" => if cube_amount.parse::<i32>().unwrap() > 13 {
                        game_impossible = true;
                    },
                    "blue" => if cube_amount.parse::<i32>().unwrap() > 14 {
                        game_impossible = true;
                    },
                    _ => continue
                }
